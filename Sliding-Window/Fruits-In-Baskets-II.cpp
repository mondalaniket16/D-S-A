...
Rule 1: Each fruit type must be placed in the leftmost available basket with a capacity 
        greater than or equal to the quantity of that fruit type.
Rule 2: Each basket can hold only one type of fruit.
rule 3: If a fruit type cannot be placed in any basket, it remains unplaced.
